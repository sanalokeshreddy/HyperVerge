...
"[project]/src/app/school/admin/create/page.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function CreateSchool() {
    ...
    const { schools, isLoading: isLoadingSchools } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSchools"])();
    ...
    const [slug, setSlug] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$15$2e$4$2e$5_$40$babel$2b$core$40$7$2e$2_ed7b963b8b79c6973a19a9ac5bbdca45$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("");
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$15$2e$4$2e$5_$40$babel$2b$core$40$7$2e$2_ed7b963b8b79c6973a19a9ac5bbdca45$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "CreateSchool.useEffect": ()=>{
            if (schools && schools.length > 0) {
                const ownedSchool = schools.find({
                    "CreateSchool.useEffect.ownedSchool": (school)=>school.role === 'owner'
                }["CreateSchool.useEffect.ownedSchool"]);
                if (ownedSchool) {
                    router.push("/school/admin/".concat(ownedSchool.id));
                }
            }
        }
    }["CreateSchool.useEffect"], [
    ...
    const baseUrl = "".concat(("TURBOPACK compile-time value", "http://localhost:3000"), "/school/");
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            ...
            const response = await fetch("".concat(("TURBOPACK compile-time value", "http://localhost:8001"), "/organizations/"), {
                method: 'POST',
                headers: {
    ...
    const navigateToSchool = ()=>{
        if (newSchoolId) {
            ...
            window.location.href = "/school/admin/".concat(newSchoolId);
        }
    };
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$15$2e$4$2e$5_$40$babel$2b$core$40$7$2e$2_ed7b963b8b79c6973a19a9ac5bbdca45$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$15$2e$4$2e$5_$40$babel$2b$core$40$7$2e$2_ed7b963b8b79c6973a19a9ac5bbdca45$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    ...
                                                    children: [
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$15$2e$4$2e$5_$40$babel$2b$core$40$7$2e$2_ed7b963b8b79c6973a19a9ac5bbdca45$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                            className: "bg-[#161925] px-3 sm:px-4 py-3 rounded-t-md sm:rounded-l-md sm:rounded-tr-none text-gray-300 border border-gray-800 sm:text-sm md:text-base overflow-x-auto whitespace-nowrap ".concat(slugError ? 'border-red-500' : ''),
                                                            children: baseUrl
                                                        }, void 0, false, {
                                                            fileName: "[project]/src/app/school/admin/create/page.tsx",
                                                            lineNumber: 275,
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$15$2e$4$2e$5_$40$babel$2b$core$40$7$2e$2_ed7b963b8b79c6973a19a9ac5bbdca45$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                                                            ...
                                                            className: "flex-1 px-3 sm:px-4 py-3 rounded-b-md sm:rounded-r-md sm:rounded-bl-none bg-[#161925] border border-gray-800 sm:border-l-0 border-t-0 sm:border-t text-white focus:outline-none focus:ring-1 focus:ring-white ".concat(slugError ? 'border-red-500' : ''),
                                                            required: true,
                                                            pattern: "[a-z0-9-]+",
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$15$2e$4$2e$5_$40$babel$2b$core$40$7$2e$2_ed7b963b8b79c6973a19a9ac5bbdca45$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    ...
                                                    children: [
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$15$2e$4$2e$5_$40$babel$2b$core$40$7$2e$2_ed7b963b8b79c6973a19a9ac5bbdca45$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                            className: "text-gray-400 ".concat(slugError ? 'sm:ml-auto' : 'w-full text-right'),
                                                            children: [
                                                                slug.length,
                                                                "/121"
                                                            ]
                    ...
                    Array.from({
                        ...
                        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$15$2e$4$2e$5_$40$babel$2b$core$40$7$2e$2_ed7b963b8b79c6973a19a9ac5bbdca45$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$framer$2d$motion$40$12$2e$23$2e$12_reac_5b43fd040792bcb2acb99491a009e4d7$2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$render$2f$components$2f$motion$2f$proxy$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["motion"].div, {
                            ...
                            style: {
                                ...
                                borderRadius: '50%',
                                background: "radial-gradient(circle at 30% 30%, hsla(".concat(hue, ", 80%, 75%, 0.8), hsla(").concat(hue, ", 80%, 75%, 0) 70%)"),
                                filter: 'blur(1px)',
                                boxShadow: "0 0 8px 2px hsla(".concat(hue, ", 80%, 70%, 0.3)"),
                                zIndex: 51
                            },
                            transition: {
                                delay,
...
_s(CreateSchool, "pjvvbtyEZuZy8swqMnAjFSYIuCE=", false, function() {
    return [
...
_c = CreateSchool;
var _c;
__turbopack_context__.k.register(_c, "CreateSchool");
...
//# sourceMappingURL=src_app_school_admin_create_page_tsx_6a225142._.js.map