...
"[project]/node_modules/.pnpm/emoji-mart@5.6.0/node_modules/emoji-mart/dist/module.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function $f72b75cf796873c7$var$get(key) {
    try {
        const value = window.localStorage["emoji-mart.".concat(key)];
...
function $b22cfd0a55410b4f$var$get(param) {
    let { maxFrequentRows: maxFrequentRows, perLine: perLine } = param;
...
function $7adb23b0109cc36a$export$2cd8252107eb640b(options) {
    let { caller: caller } = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
    ...
    else if (caller && !$7adb23b0109cc36a$var$initialized) console.warn("`".concat(caller, "` requires data to be initialized first. Promise will be pending until `init` is called."));
...
async function $7adb23b0109cc36a$var$_init(props) {
    ...
    if (!$7adb23b0109cc36a$export$2d0294657ab35f1b) {
        $7adb23b0109cc36a$export$2d0294657ab35f1b = (typeof props.data === "function" ? await props.data() : props.data) || await $7adb23b0109cc36a$var$fetchJSON("https://cdn.jsdelivr.net/npm/@emoji-mart/data@latest/sets/".concat(emojiVersion, "/").concat(set, ".json"));
    ...
    $7adb23b0109cc36a$export$dbe3113d60765c1a = (typeof props.i18n === "function" ? await props.i18n() : props.i18n) || (locale == "en" ? (0, /*@__PURE__*/ $parcel$interopDefault($8d50d93417ef682a$exports)) : await $7adb23b0109cc36a$var$fetchJSON("https://cdn.jsdelivr.net/npm/@emoji-mart/data@latest/i18n/".concat(locale, ".json")));
        ...
        while(emojiIndex--){
            ...
            if (!emoji.search) {
                ...
                for (const skin of emoji.skins){
                    ...
                    const skinShortcodes = skinIndex == 1 ? "" : ":skin-tone-".concat(skinIndex, ":");
...
async function $c4d155af13ad4d4b$var$search(value) {
    let { maxResults: maxResults, caller: caller } = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
    ...
    for (const value1 of values){
        ...
        for (const emoji of pool){
            ...
            const score = emoji.search.indexOf(",".concat(value1));
            if (score == -1) continue;
            results.push(emoji);
...
async function $693b183b0a78708f$export$e772c8ff12451969() {
...
function $693b183b0a78708f$export$d10ac59fbe52a745(emoji) {
    let { skinIndex: skinIndex = 0 } = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
...
function $254755d3f438722f$export$2e2bcd8739ae039(props) {
    ...
    const imageSrc = emojiSkin.src || (props.set != "native" && !props.spritesheet ? typeof props.getImageURL === "function" ? props.getImageURL(props.set, emojiSkin.unified) : "https://cdn.jsdelivr.net/npm/emoji-datasource-".concat(props.set, "@15.0.1/img/").concat(props.set, "/64/").concat(emojiSkin.unified, ".png") : undefined);
    const spritesheetSrc = typeof props.getSpritesheetURL === "function" ? props.getSpritesheetURL(props.set) : "https://cdn.jsdelivr.net/npm/emoji-datasource-".concat(props.set, "@15.0.1/img/").concat(props.set, "/sheets-256/64.png");
...
class $89bd6bb200cc8fef$export$2e2bcd8739ae039 extends (0, $fb96b826c0c5f37a$export$16fa2f45be04daa8) {
    ...
    async reset() {
        let nextState = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
    ...
    unregister() {
        ...
        (_this_darkMedia = this.darkMedia) === null || _this_darkMedia === void 0 ? void 0 : _this_darkMedia.removeEventListener("change", this.darkMediaCallback);
        this.unobserve();
    }
    observe() {
        this.observeCategories();
    ...
    unobserve() {
        let { except: except = [] } = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
    ...
    navigate(param) {
        let { e: e, input: input, left: left, right: right, up: up, down: down } = param;
        const grid = this.state.searchResults || this.grid;
    ...
    scrollTo(param) {
        let { categoryId: categoryId, row: row } = param;
        const grid = this.state.searchResults || this.grid;
        if (!grid.length) return;
    ...
    handleEmojiClick(param) {
        let { e: e, emoji: emoji, pos: pos } = param;
    ...
    renderEmojiButton(emoji, param) {
        let { pos: pos, posinset: posinset, grid: grid } = param;
    ...
    constructor(props){
        ...
        (0, $c770c458706daa72$export$2e2bcd8739ae039)(this, "handleCategoryClick", (param)=>{
            let { category: category, i: i } = param;
            this.scrollTo(i == 0 ? {
                row: -1
            } : {
...
//# sourceMappingURL=c3d6e_emoji-mart_dist_module_cc437c67.js.map